...
plt.plot(bins,eff_function(bins,*popt2),color='red',label=r'$\Delta ll \leq -22$ \& npix1p6 $\leq$ 1' )
plt.xlim(0.03,0.5)
plt.ylim(0,1)
plt.xlabel('ene1 [keV]')
plt.ylabel('efficiency')
